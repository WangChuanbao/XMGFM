...
@interface XMGSegmentBar()<UICollectionViewDelegate>
...
@property (nonatomic, strong) XMGSegmentConfig *segmentConfig;

@property (nonatomic, strong) XMGSegmentRightLeftBtn *showMoreBtn;
@property (nonatomic, nonnull, strong) UIView *coverView;
@property (nonatomic, strong) XMGMenueBarShowDetailCVC *showDetailVC;
...
- (XMGMenueBarShowDetailCVC *)showDetailVC {
    if (!_showDetailVC) {
        _showDetailVC = [[XMGMenueBarShowDetailCVC alloc] init];
...
- (XMGSegmentRightLeftBtn *)showMoreBtn
{
    if (!_showMoreBtn) {
        ...
        _showMoreBtn = [[XMGSegmentRightLeftBtn alloc] init];
...
+ (instancetype)segmentBarWithConfig: (XMGSegmentConfig *)config {
    ...
    XMGSegmentBar *segBar = [[XMGSegmentBar alloc] initWithFrame:defaultFrame];
...
-(instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.segmentConfig = [XMGSegmentConfig defaultConfig];
    }
    return self;
}
...
-(void)setSegmentConfig:(XMGSegmentConfig *)segmentConfig
{
 ...
 */
-(void)setSegmentMs:(NSArray<id<XMGSegmentModelProtocol>> *)segmentMs
{
    ...
    // 添加最新的子控件
    for (NSObject<XMGSegmentModelProtocol> *segM in segmentMs) {
